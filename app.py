...
def set_bg(url):
    st.markdown(
        ...
        /* Blok ichidagi "Tizimga kirish" sarlavhasi */
        .login-header {{
            color: #1E1E1E;
            font-size: 28px;
            font-weight: bold;
...
if "authenticated" not in st.session_state:
    ...
    with col2:
        ...
        # 2. Sarlavha (Blokning eng tepasida)
        st.markdown('<div class="login-header">Tizimga kirish</div>', unsafe_allow_html=True)
        
        # 3. Parol kiritish (labelni yashirdik, placeholder ichida)
...
# --- QOLGAN QISMLAR (Tizimga kirgandan keyin) ---
